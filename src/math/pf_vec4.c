...
PF_MATH_FLOAT pf_vec4_len(const pf_vec4_t v)
{
    return sqrtf(v[0]*v[0] + v[1]*v[1] + v[2]*v[2] + v[3]*v[3]);
}

PF_MATH_FLOAT pf_vec4_len_sq(const pf_vec4_t v)
{
    return v[0]*v[0] + v[1]*v[1] + v[2]*v[2] + v[3]*v[3];
}

PF_MATH_FLOAT pf_vec4_dot(const pf_vec4_t v1, const pf_vec4_t v2)
{
