...
void
pf_renderer3d_line(
    pf_renderer3d_t* rn, const pf_vertex3d_t* v1, const pf_vertex3d_t* v2,
    const pf_mat4_t transform, pf_proc3d_generic_t* proc)
{
    ...
    pf_renderer3d_line_INTERNAL(rn, v1, v2, 0, mat_model, mat_normal, mat_mvp, &processor);
}
    ...
    const pf_mat4_t transform, pf_proc3d_generic_t* proc)
{
    ...
    pf_renderer3d_line_INTERNAL(rn, v1, v2, thick, mat_model, mat_normal, mat_mvp, &processor);
}
